...
public class ActorCriticLambdaLearner extends ActorCriticLearner {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8983430755451044975L;
	...
	public ActorCriticLambdaLearner(int stateCount, int actionCount, double alpha, double gamma, double lambda,
			double initialP) {
