 ...
 * @since 21/12/2018
 *
 *        Implement temporal-difference learning Sarsa, which is an on-policy TD
 *        control algorithm
 */
public class SarsaAgent implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8899924993513610584L;
	...
	public boolean equals(Object obj) {
		if (obj != null && obj instanceof SarsaAgent) {
			...
			return prevAction == rhs.prevAction && prevState == rhs.prevState && currentAction == rhs.currentAction
					&& currentState == rhs.currentState && learner.equals(rhs.learner);
		}
		return false;
	}
}
